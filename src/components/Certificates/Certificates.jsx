...
import RPAFundamentals from "../../Assets/Cerificates/RPAFundamentals.png"
import Flashcard_Generator from "../../Assets/Cerificates/Flashcard_Generator.png"
        ...
        <Container fluid className="project-section">
            ...
            <Container>
                ...
                <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
                    ...
                    <Col md={6} className="project-card">
                        <CertificateCard
                            img={Flashcard_Generator}
                            title={"Flashcard_Generator_Frontend_Project"}
                        />
                    </Col>
